                    ...
                    <form action="PDS/insert_family.php" method="POST">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-2">
                                ...
                                <input type="text" name="spouse_sname" class="form-control" placeholder="Surname" required>
                            </div>
                            <div class="col-md-3 mb-2">
                                <label>First Name:</label>
                                <input type="text" name="spouse_fname" class="form-control" placeholder="First Name" required>
                            </div>
                            <div class="col-md-3 mb-2">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="text" name="father_sname" class="form-control" placeholder="Surname" required>
                            </div>
                            <div class="col-md-4 mb-2">
                                <label>First Name:</label>
                                <input type="text" name="father_fname" class="form-control" placeholder="First Name" required>
                            </div>
                            <div class="col-md-4 mb-2">
                                <label>Middle Name:</label>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="text" name="mothers_sname" class="form-control" placeholder="Surname" required>
                            </div>
                            <div class="col-md-4 mb-2">
                                <label>First Name:</label>
                                <input type="text" name="mothers_fname" class="form-control" placeholder="First Name" required>
                            </div>
                            <div class="col-md-4 mb-2">
                                <label>Middle Name:</label>
