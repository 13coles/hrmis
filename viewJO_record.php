            ...
            <div class="container-fluid d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    <?php $token = encrypt_id($employee['employee_id']);?>
                     <a href="editJO.php?token=<?php echo $token; ?>" class="btn btn-primary-outline btn-sm mr-3">
                    <i class="fas fa-edit"></i> Edit Record</a>

                    <?php $token = encrypt_id($employee['employee_id']);?>
                    <a href="printJO_record.php?token=<?php echo $token; ?>" class="btn btn-primary"><i class="fas fa-print"></i> Print</a>
                </div>
            </div>
        </section>
