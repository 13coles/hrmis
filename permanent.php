...
$query = "SELECT id, employee_no, last_name, first_name, middle_name, extension_name, department_name, date_hired, position FROM employees";
                                    ...
                                    <td>
                                        <div class="dropdown d-flex justify-content-center">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <!-- View PDS -->
                                                <form action="view_personalInfo.php" method="POST" class="mb-0">
                                                 ...
                                                 <!-- View Card -->
                                                 <form action="leaveCard.php" method="POST" class="mb-0">
                                                ...
                                                <!-- View Record -->
                                                <form action="viewRecord.php" method="POST" class="mb-0">
                                                <input type="hidden" name="employee_id" value="<?php echo $row['id']; ?>">
                                                    <button type="submit" class="dropdown-item text-sm">
